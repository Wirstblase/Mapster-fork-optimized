...
public struct MapFeature
{
    ...
    public static EnumMapper.Values[] HighwayTypes =
    {
        EnumMapper.Values.Highway_Motorway, EnumMapper.Values.Highway_Trunk, EnumMapper.Values.Highway_Primary, 
        EnumMapper.Values.Highway_Secondary, EnumMapper.Values.Highway_Tertiary, EnumMapper.Values.Highway_Unclassified, 
        EnumMapper.Values.Highway_Residential, EnumMapper.Values.Highway_Road
    };
